package com.ph.common.ui.loader;
...
public class EclipseLoadingView extends View {
    ...
    private void initAnimator() {
        ...
        animator4.addUpdateListener(animation -> setEclipseOffsetX((Float) animation.getAnimatedValue()));

        animatorSet = new AnimatorSet();
//        animatorSet.playSequentially(animator1, animator2, animator3, animator4);
        animatorSet.playSequentially(animator1, animator4);
